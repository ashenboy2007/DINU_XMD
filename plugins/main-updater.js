...
cmd({
    ...
    try {
        await reply("🔍 Checking for 𝙳𝙰𝚁𝙺-𝙰𝚂𝙷𝙴𝙽-𝚇𝙼𝙳 updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your 𝙳𝙰𝚁𝙺-𝙰𝚂𝙷𝙴𝙽-𝚇𝙼𝙳 bot is already up-to-date!");
        }

        await reply("🚀 Updating 𝙳𝙰𝚁𝙺-𝙰𝚂𝙷𝙴𝙽-𝚇𝙼𝙳 Bot...");
        ...
        const sourcePath = path.join(extractPath, "DARK-𝙰𝚂𝙷𝙴𝙽-XMD-main");
